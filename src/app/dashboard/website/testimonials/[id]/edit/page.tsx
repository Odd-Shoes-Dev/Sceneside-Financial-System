    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">{formData.customer_name}</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="card">
          ...
          <div className="card-body space-y-4">
            ...
            <div>
              <label className="label">Customer Title/Position</label>
              <input
                type="text"
        ...
        <div className="card">
          ...
          <div className="card-body">
            <label className="label mb-3">Select Rating</label>
