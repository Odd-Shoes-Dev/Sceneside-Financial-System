    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="card">
          ...
          <div className="card-body space-y-4">
            <div>
              <label className="label">Short Description (for listings)</label>
              <textarea
          ...
          <div className="card-body space-y-4">
            <label className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Display this hotel prominently on the homepage</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Show this hotel on the public website</p>
              </div>
            </label>
          </div>
        </div>
