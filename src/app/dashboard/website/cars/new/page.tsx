          ...
          <div className="card-body space-y-4">
            <label className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Basic insurance is included in the rental price</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Display this vehicle prominently</p>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Show this vehicle on the public website</p>
              </div>
            </label>
          </div>
        </div>
