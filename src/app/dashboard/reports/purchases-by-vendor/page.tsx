...
export default function PurchasesByVendorPage() {
  ...
  const exportToPDF = () => {
    ...
    const printHTML = `
      <html>
        <head>
          <title>Purchases by Vendor Report - ${formatDate(data.reportPeriod.startDate)} to ${formatDate(data.reportPeriod.endDate)} - Sceneside L.L.C</title>
          <style>
        ...
        <>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-3 sm:px-6 py-3 sm:py-4 border-b border-gray-100">
              <div className="flex items-center gap-2 sm:gap-3">
                <ChartBarIcon className="w-4 h-4 sm:w-5 sm:h-5 text-sceneside-navy" />
